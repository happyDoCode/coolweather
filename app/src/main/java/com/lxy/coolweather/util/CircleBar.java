...
public class CircleBar extends View {
    ...
    private int mTextColor = getResources().getColor(R.color.circleBlue);//默认文字颜色
    private int mWheelColor = getResources().getColor(R.color.circleBlue);//默认圆环颜色
    ...
    private void init() {
        ...
        mDistance = dip2px(getContext(), 15);//文字距离
        //外圆环的画笔
        ...
        textDesPaint.setColor(getResources().getColor(R.color.colorDarkText));
